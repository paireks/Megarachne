...
namespace Megarachne
{
    public class DijkstraShortestPathGH : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Path path = dijkstra.GetShortestPath(startVertexIndex, endVertexIndex);
            ...
            DA.SetDataList(4, dijkstra.VisitedVertices);
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Properties.Resources.DijShortestPath;
            }
        }
